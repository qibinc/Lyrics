...
class DataReader(object):
    ...
    def _setCardinality(self):
        ...
        self.cardinality = []
        with open('resource/feat_template.txt') as fin:
            self.dfs = [0,0,0,0,0]
